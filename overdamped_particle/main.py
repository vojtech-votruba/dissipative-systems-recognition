...
if args.plot:
    ...
    if DIMENSION == 1:
        ...
        sample = test_pos[np.random.randint(0,len(test_pos)-1)].detach().numpy()
        ...
        ax6.plot(x_star_range, 1/2 * x_star_range**2, label="analytic")
        ax6.legend()
        ...
        ax7.plot(x, -1/2 * x**2, label="analytic")
        ax7.legend()
